...
public abstract class EntityAbstract {
    ...
    public void setId(Integer id) {
        LOGGER.warn("`Id` is an autogenerated field, setting the value of an autogenerated field explicitly can cause issues.");
        this.id = id;
    }
    ...
    /**
     * Hides sensitive information when converting entities to string
     *
     * @return
     */
    @Override
